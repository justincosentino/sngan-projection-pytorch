...
@registry.register("generator_resnet_64")
class GenResNet64(torch.nn.Module):
    def __init__(
        self,
        num_channels=64,
        dim_z=128,
        ...
        super(GenResNet64, self).__init__()
        ...
        self.b6 = torch.nn.BatchNormalization(num_channels)
        self.c6 = torch.nn.Convolution2D(
            in_channels=num_channels, out_channels=3, kernel_size=3, stride=1, padding=1
        )
        torch.nn.init.xavier_uniform_(self.c6.weight, gain=1)
